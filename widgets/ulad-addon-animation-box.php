 ...
 * @since 1.0.0
 */
class ulad_addon_animation_box extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Animation Box', 'ultimate-addons' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}:hover .fwp-iconbox.fwp-style1' => 'background: {{VALUE}}',
				],
			]
		);
	...
	?>
	<div class="fwp-iconbox fwp-style1 <?php echo esc_attr($settings['display_alignment']); ?>">
