 ...
 * @since 1.0.0
 */
class ulad_addon_icon_carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Icon Box Carosuel', 'ultimate-addons' );
	}
	...
	protected function _register_controls() {
       ...
       $repeater = new \Elementor\Repeater();
		...
		$this->add_control(
			'icon_slider',
			[
				'label' => esc_html__( 'Icon Box Slider', 'ultimate-addons' ),
               ...
               <?php
        		...
        		<div class="swiper-slide">
                	<div class="fwp-iconbox-area <?php echo esc_attr($settings['display_alignment']); ?>">
                		<div class="fwp-icon"><i class="<?php echo $icons['icon']['value'] ?>"></i></div>
                		<div class="fwp-iconbox-info">
                		<h3 class="fwp-iconbox-title"><?php echo esc_html($icons['title']); ?></h3>
                		</div>
                	</div>
                    </div><!-- .swiper-slide -->
                     <?php } ?>
