...
class ulad_Clock_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( "Clock", 'ultimate-addons' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'clock_format', [
			'label'     => esc_html__( 'Clock Format', 'ultimate-addons' ),
			'type'      => \Elementor\Controls_Manager::SELECT,
			'options'   => [
				'12' => esc_html__( '12 Hour', 'ultimate-addons' ),
				'24' => esc_html__( '24 Hour', 'ultimate-addons' ),
			],
			'default'   => '12',
		] );
